    ...
    const dadosRecursos = [
        {
            ...
            descricao: 'Gerencie seus agendamentos de forma prática com um calendário interativo. Visualize todos seus compromissos em um só lugar e edite as informações sempre que necessário, garantindo mais organização e controle sobre sua agenda.',
            img: ImgCalendario
        },
        {
            id: 2,
        ...
        },
        {
            ...
            descricao: 'Nosso sistema contará com IA integrada ao calendário, oferecendo sugestões inteligentes, alertas automáticos e otimização dos agendamentos para mais eficiência e praticidade.',
            img: ImgIAAssistente
        },
        {
            id: 4,
