        ...
        <section className="section-home flex flex-col md:flex-row justify-between items-center p-12 md:p-40 bg-gradient-to-r from-white to-darkBlueFy mt-16" id='home'>
            <div>
                ...
                <div className="div-buttons flex gap-4 mt-4">
                    <button id="btn_primario" className="bg-lightBlueFy border-2 border-lightBlueFy text-white p-4 font-medium text-sm transition duration-300 ease-in-out hover:bg-darkestBlueFy">Saiba Mais</button>
                    <button id="btn_secundario" className="border-2 border-lightBlueFy text-lightBlueFy p-4 font-medium text-sm transition duration-300 ease-in-out hover:bg-lightBlueFy hover:text-white">Criar Conta</button>
                </div>
            </div>
