        ...
        <div className="menu-lateral flex flex-col">
            ...
            <section className='btns-menu'>
                <Link to={'/dashboard'}>
                    ...
                    <button id='btn-home' aria-label='Home'>
                ...
                <Link to={'/dashboard/agendamentos'}>
                    <button id='btn-agendamentos' aria-label='Agendamentos'>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
                ...
                <Link to={'/dashboard/pacientes'}>
                    <button id='btn-pacientes' aria-label='Pacientes'>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
                ...
                <Link to={'/dashboard/administracao'}>
                    <button id='btn-configuracoes' aria-label='Configurações'>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
